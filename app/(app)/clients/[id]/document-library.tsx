                                      ...
                                      <div
                                        ...
                                        {folders.map((folder) => (
                                                                      <button
                                                                                        ...
                                                                                        <span className="truncate">{folder.name}</span>span>
                                                                      </button>button>
                                                                    ))}
                                        {folders.length === 0 && (
          ...
          <div>
            ...
            {!isSearchActive && (
                    <div className="flex items-center justify-between -mt-2 mb-4">
                      ...
                      {backfillStatus && (
                                  <span className="text-xs text-slate-400">{backfillStatus}</span>span>
                              )}
                    </div>div>
                )}
                      ...
                      {pending.map((u) => (
                                  <div
                                    ...
                                    {u.status === "uploading" ? (
                                                ...
                                                <span className="truncate flex-1">{u.name}</span>span>
                                    {u.status === "error" && (
                                                                  <span className="text-xs shrink-0">{u.error}</span>span>
                                                )}
                                  </div>div>
                                ))}
                    </div>div>
